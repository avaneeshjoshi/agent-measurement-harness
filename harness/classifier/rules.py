...
(The rules-0.2.0 neighborhood flow rules R01c/R01d were a pre-registered
experiment, validated once, and WITHDRAWN on a negative result: +1 fix,
-3 regressions on the 81 calibration labels — ADR-0013. The neighborhood
machinery survives in features.py for future label rounds; these rules do
not consume it.)
