...
versioned sheet ({H.escape(s['pricing']['as_of'])}) over all four token buckets; on a
...
<code>caliper report</code>. This file and the name mapping live in the gitignored
