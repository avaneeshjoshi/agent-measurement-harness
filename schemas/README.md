...
| `task_class.schema.json` | A classification of one unit of agent work (prompt / segment / session): task type × context breadth × risk axes, with unit, classifier version, and confidence | `harness/classifier` | `harness/replay`, `harness/routing`, `dashboard/` |
