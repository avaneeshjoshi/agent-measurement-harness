...
Dark theme overrides: `--bg #0F0F0E` · `--surface-1 #191917` · `--surface-2 #232320` · `--edge` white 11% (18% hover) · `--edge-strong #4A4843` · `--text-1 #F7F5F2` · `--text-2 #B6B1A8` · `--text-3 #8B867D` · `--accent #8FBFA4` · `--measured #8FAE8B` · `--provisional #D9A47E` · `--absent` `#8B867D` on `--surface-2` at 40% · `--danger #C97B6F`. Same contrast obligations as light.
