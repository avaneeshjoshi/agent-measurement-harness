...
*Evidence:* ADR-0011; `tests/test_health.py` (16), `tests/test_collection.py` (10), `tests/test_schedule.py` (11), `tests/test_paths.py` (8) — 82 total passing. Live on this machine since 2026-08-23: installed extraction-only, kickstart-verified, watermarked run examined 3 of 220+ artifacts; the gap warning's first firing (under the since-corrected 3-day constant) flagged a real 5-day lapse the same day — see the retention finding under Known gaps for why that alarm overstated loss.
